...
import { FaJava, FaPython, FaJsSquare, FaHtml5, FaCss3Alt, FaReact, FaNodeJs, FaGitAlt, FaDocker, FaUnity } from 'react-icons/fa';
    ...
    <div className="border-b border-neutral-800 pb-24">
      ...
      >
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaPython className="text-7xl text-orange-500" />
        ...
        <motion.div
          ...
          className="rounded-2xl border-4 border-neutral-800 p-4"
        >
          <FaUnity className="text-7xl text-black-500" />
